namespace PaperModule
{
    ...
    class Program
    {
        ...
        static async Task<MessageResponse> PipeMessage(Message message, object userContext)
        {
            ...
            Product deserializedProduct = JsonConvert.DeserializeObject<Product>(messageString);
            deserializedProduct.MillisecondsPaper = milliseconds;
            messageString = JsonConvert.SerializeObject(deserializedProduct);
